...
@Observable class DialogueViewModel {
    ...
    func addDialogue(conversations: [Conversation] = [],title:String="新的聊天",model_topic:String="",promptModel:String="") {
//        if let first = allDialogues.first {
...
//        }
    ...
    func addNewDialogue(conversations: [Conversation] = [],title:String="新的聊天",model_topic:String="") -> DialogueSession {
